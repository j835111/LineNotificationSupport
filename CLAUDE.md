...
This is a single-module Android app (Java, minSdk 34, compileSdk 35) that acts as a system `NotificationListenerService` for the LINE messaging app. The app intercepts LINE notifications, transforms them, and re-publishes them in a watch-friendly format.
